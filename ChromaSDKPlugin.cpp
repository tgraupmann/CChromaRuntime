...
ChromaSDKPlugin::ChromaSDKPlugin()
{
	...
	_mMethodInit = NULL;
	_mMethodUnInit = NULL;
	_mMethodCreateEffect = NULL;
	_mMethodCreateChromaLinkEffect = NULL;
	_mMethodCreateHeadsetEffect = NULL;
	_mMethodCreateKeyboardEffect = NULL;
	_mMethodCreateKeypadEffect = NULL;
	_mMethodCreateMouseEffect = NULL;
	_mMethodCreateMousepadEffect = NULL;
	_mMethodSetEffect = NULL;
	_mMethodDeleteEffect = NULL;
	_mMethodQueryDevice = NULL;
